...
Shows how a GitHub-hosted runner wrapper would consume the core isolated expansion VNet. GitHub Network Settings, official allow-lists, and organization binding belong in a separate wrapper module.
...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_runner_expansion"></a> [runner\_expansion](#module\_runner\_expansion) | ../.. | n/a |
