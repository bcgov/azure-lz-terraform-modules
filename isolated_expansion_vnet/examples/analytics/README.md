...
Shows how an analytics or Databricks wrapper would consume the core isolated expansion VNet. Workspace, storage, and service-specific NSG rules belong in a separate wrapper module.
...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_analytics_expansion"></a> [analytics\_expansion](#module\_analytics\_expansion) | ../.. | n/a |
