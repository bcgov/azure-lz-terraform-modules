variable "IPAM_TOKEN" {
  ...
  # For local testing, add the IPAM token to an environment variable using:
  # export TF_VAR_IPAM_TOKEN=$(az account get-access-token --resource api://8b672441-25f3-4a33-8336-d853c466a782 --query="accessToken" | tr -d '"')
}
