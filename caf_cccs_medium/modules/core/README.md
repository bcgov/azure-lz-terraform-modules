...
| <a name="input_deny_copilot_studio_parameters"></a> [deny\_copilot\_studio\_parameters](#input\_deny\_copilot\_studio\_parameters) | Parameter values for the Deny-Copilot-Studio policy assignment. | <pre>object({<br/>    effect = string<br/>  })</pre> | n/a | yes |
