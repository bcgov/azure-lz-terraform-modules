variable "public_ingress_security_best_prac_parameters" {
  type = object({
    ...
    app_gateway_log_analytics_destination_type          = optional(string, "Dedicated")
    ...
    load_balancer_log_analytics_destination_type        = optional(string, "Dedicated")
    ...
    api_management_log_analytics_effect                 = optional(string, "AuditIfNotExists")
    api_management_log_category_group                   = optional(string, "allLogs")
    api_management_log_analytics_destination_type       = optional(string, "Dedicated")
