...
module "lz_custom_private_dns_zones" {
  source = "git::https://github.com/bcgov/azure-lz-terraform-modules.git//azure_private_dns/private_dns_zone?ref=caf-custom-dns-depends"
...
module "private_dns_zone_virtual_network_link" {
  source = "git::https://github.com/bcgov/azure-lz-terraform-modules.git//azure_private_dns/private_dns_zone_virtual_network_link?ref=caf-custom-dns-depends"
